...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FILMSOURCE_LIST actions', async () => {
    ...
    it('dispatches FETCH_FILMSOURCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FILMSOURCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FILMSOURCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FILMSOURCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FILMSOURCE actions', async () => {
      const expectedActions = [
        {
